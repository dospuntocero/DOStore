	...
	<tr>
		<td>
			<ul style="width:590px;list-style:none;margin:0;padding:5px;background:#F4F4F4;">
				<li style="margin:5px;padding:0px;"><p><% _t('CartEmail.SUBMITTERINFO','The following purchase was submitted to your site by') %> <strong><a href="mailto:$Email?subject=<% _t('CartEmail.RECENTPURCHASE','recent%20purchase') %>">$Name</a></strong>:</li>
			</ul>
			<% with Order %>
